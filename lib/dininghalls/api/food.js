...
class FoodModule extends WebserverModule_1.default {
    constructor(data) {
    ...
    static getRequestUrl({ diningHall, date, meal }) {
        return encodeURI(`${config.pages.EAT_AT_STATE + config.pages.DINING_HALL_MENU + diningHall.fullName}/all/${date}?field_mealtime_target_id=${enum_1.MealIdentifier.getByIndex(meal)}`);
    }
