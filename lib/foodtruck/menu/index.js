...
class FoodTruckMenuModule extends webserver_module_1.default {
    ...
    static retrieveMenusFromWeb() {
        return __awaiter(this, void 0, void 0, function* () {
            let htmlResponse;
            try {
                htmlResponse = yield cache_1.cache.getValue(cache_1.CacheKey.foodTruckHtml);
            }
            catch (e) {
                throw e;
            }
    ...
    start() {
        ...
        router.get('/api/msu/foodtruck/menu', cache_1.handleEndpoint(cache_1.CacheKey.foodTruckMenu, FoodTruckMenuModule.retrieveMenusFromWeb));
        this.app.use(router);
    }
}
exports.default = FoodTruckMenuModule;
