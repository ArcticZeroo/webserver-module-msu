...
class FoodModule extends webserver_module_1.default {
    constructor(data) {
        ...
        this.cache = new expiring_cache_1.default(async (key) => this.retrieveDiningHallMenuFromWeb(await this.deserializeFromKey(key)), 12 * 60 * 60 * 1000);
    }
    ...
    async retrieveDiningHallMenuFromWeb({ diningHall, menuDate, meal }) {
