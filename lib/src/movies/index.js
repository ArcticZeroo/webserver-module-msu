...
async function getMovieShowings() {
    let page;
    try {
        page = await request_1.default(index_1.default.pages.MOVIE_NIGHT);
    }
    catch (e) {
        throw e;
    }
...
router.get('/list', index_2.handleEndpoint(index_2.CacheKey.movieNightShowings, getMovieShowings));
